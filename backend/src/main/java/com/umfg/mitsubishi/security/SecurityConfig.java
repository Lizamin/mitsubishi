...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SecurityConfig(MitsubishiUserDetailsService mitsubishiUserDetailsService) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .addFilter(new JWTAuthorizationFilter(authenticationManager(), mitsubishiUserDetailsService));
    }
